About django-tree-queries-feedstock
===================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/django-tree-queries-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/django-tree-queries-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add django-tree-queries
# for installing globally
pixi global install django-tree-queries
```
...
It is possible to list all of the versions of `django-tree-queries` available on your platform:
...
```
pixi search django-tree-queries --channel conda-forge
```
